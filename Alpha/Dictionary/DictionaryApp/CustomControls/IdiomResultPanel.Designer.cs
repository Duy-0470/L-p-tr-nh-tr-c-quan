...
{
    partial class IdiomResultPanel
    {
        /// <summary> 
        ...
        {
            this.otherResultsPanel = new DictionaryApp.CustomControls.OtherIdiomResultsPanel(mw);
            this.SuspendLayout();
            ...
            if (w.Count != 0)
            {
                ...
                foreach(Idiom idiom in w)
                {
                    this.wordDefinition = new DictionaryApp.CustomControls.IdiomDefinition(idiom);
                    ...
                    this.wordDefinition.Location = new System.Drawing.Point(0, 
                            c.Count ==0 ?0:
                            c[c.Count-1].Location.Y+ 
                            c[c.Count - 1].PreferredSize.Height-20);
                    c.Add(this.wordDefinition);
                }
        ...
        private OtherIdiomResultsPanel otherResultsPanel;
        private IdiomDefinition wordDefinition;
